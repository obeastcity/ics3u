...
public class TimeMachine {
	...
	public static void main(String[] args) {
		...
		// Jack and Sonam's adventure game
		// 20/03/2017
		//period four
		//teacher: Ms. kemp
		...
		do{  //restart
			...
			c.drawImage (timeMachine, 0, 0, null); //the beginning
									...
									if (choiceE.equals("a")){
										...
										if (choiceF.equals("a")){
											...
											if (choiceJ.equals("a")){
												...
												c.println("(why would an old house have a working elevator!?)"); //you die
